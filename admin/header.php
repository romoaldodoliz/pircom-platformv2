...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* ===== NOVO: Container que NÃO adiciona padding extra ===== */
        .pircom-page-container {
            flex: 1;
            background: var(--pircom-gray-100);
            width: 100%;
        }
...
<body>
    ...
    <div class="pircom-layout-wrapper">
        ...
        <main class="pircom-main-content" id="pircomMainContent">
            ...
            <!-- Page Container - SEM NENHUM PADDING - Apenas um container limpo -->
            <div class="pircom-page-container">
